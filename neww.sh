...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" FERDI ERLANGGA  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Ferdi Helfynt"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3C3L] [MR.R0B1] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [S1K4NC3]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 081293603132"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" kegantengan06@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 081293603132"
echo $ku"Facebook :"$i" Ferdi Helfynt"
sleep 2
